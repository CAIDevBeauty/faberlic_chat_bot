...
from .responses import get_welcome_text, get_cannot_extract_all_slots_text
...
script = {
    "general_flow": {
        ...
        "fallback_node": {
            ...
            TRANSITIONS: {
                ("general_flow", "start_node"): cnd.true()
            }
        },
    },
    "chat_flow": {
        "intro_node": {
            ...
            TRANSITIONS: {
                ...
                ("chat_flow", 'details_node'): cnd.all([loc_cnd.has_intent(["purchase of goods"]), cnd.negation(loc_cnd.is_slots_full(['hair_type', 'product_type', 'price', 'series']))]),
                ("chat_flow", "faq_node"): cnd.negation(loc_cnd.has_intent(['purchase_of_goods'])),
