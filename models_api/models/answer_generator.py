    ...
    async def get_answer(self, text, products_description) -> str:
        ...
        completion = await self._openai_client.acreate(
            ...
            messages=[
                ...
                {"role": 'system', "content": f"Ты - консультант магазина косметики в отделе ухода за волосами. Используя описание товара и запрос клиента порекомендуй клиенту товар. Ничего не придумывай, используй только предоставленную информацию. Сделай рекомендацию короткой."},
